...
<td <c:if test='${yield > 0}'>class='text-success text-nowrap'</c:if> <c:if test='${yield < 0}'>class='text-danger'</c:if>>${yield} % &nbsp;</td>
		 ...
		 <div id="last-10-div" class="col-sm-12 col-md-9 col-lg-6">
				<div class="row">
					   <div class="col-12">
					   <p class="font-weight-normal text-success d-block text-center">ACTIVE PAID TIPS</p>
				       <div class="table-responsive">
					   <table id="last-10-table" class="table table-dark text-light table-hover">
					   <thead>
					   <tr class="head"><td>&nbsp;</td><td style="width:70px; text-align:left">Time</td><td>Event</td><td>Tipster</td><td align="left">Bookie</td></tr>
					   </thead>
					   <tbody>
...
<td class="text-nowrap bookmakercolumn" style="text-align:left">${freeactivetips.bookmaker}</td>
				   ...
				   <div class="row">
				      <div class="col-12">
				     <p class="font-weight-normal text-success d-block text-center">FINISHED PAID TIPS</p>
					    <div class="table-responsive">
					   <table id="last-10-paid-table" class="table table-dark text-light table-hover">
					   <thead>
					   <tr class="head"><td>&nbsp;</td><td style="width:70px; text-align:left">Time</td><td>Event</td><td>Tipster</td><td align="left">Bookie</td><td style="width:70px; text-align:left">Result</td>
					   </tr>
					   </thead>
					   <tbody>
...
<td class="text-nowrap" style="text-align:center"><c:if test='${freefinishedtips.result=="won"}'><img src="https://www.eagletip.com/images/css/right.svg" style="width:20px;height:20px"/></c:if><c:if test='${freefinishedtips.result=="lost"}'><img src="https://www.eagletip.com/images/css/wrong.svg" style="width:20px;height:20px"/></c:if></td>
                       ...
                       <a class="text-primary" style="text-decoration:underline" href="https://www.eagletip.com/tips?page=1&category=paid">See all Paid tips</a>
                       </div>
...
<script src="https://www.eagletip.com/main.js"></script>
<script>
...
function getCookie(name) {
 ...
 $(document).ready(function(){
	 ...
	 $("#paidtipslink").addClass("text-dark");
