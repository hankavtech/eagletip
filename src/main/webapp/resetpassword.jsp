...
<form method="post" class="form" id="changepass" action="https://www.eagletip.com/ChangePassword" autocomplete="on">
     <img class="mb-3" src="https://www.eagletip.com/images/css/hockey.svg" style="width:50px;height:50px;margin-left:70px"/>
...
$.ajax({
	method:"POST",
	url:"https://www.eagletip.com/ChangePassword",
	data:{email:$("#email2").val().trim(),password:$("#password2").val().trim()},
	success:function(res){
        		if(res.trim()=="success"){
        			$("#message").show();
        			setTimeout(function() {
        				location.href="https://www.eagletip.com"						
					}, 2000);
        		}
	}
