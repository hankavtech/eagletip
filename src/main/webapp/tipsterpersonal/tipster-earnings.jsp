...
<div class="container mt-5">
 <ul class="nav nav-tabs" id="myTab" role="tablist">
  ...
  <li class="nav-item">
    <a class="nav-link active" id="profile-tab" href="https://www.eagletip.com/tipsterpersonal/earnings" role="tab" aria-controls="profile" aria-selected="true">Earnings</a>
  </li>
  <li class="nav-item">
...
<div class="tab-content">
 ...
 <h4 class="mb-1 mt-3"> Your registered paypal email: ${requestScope.paymentemail}</h4>
  <form  method="POST" id="paymentemailform" class="form" action="https://www.eagletip.com/ChangePaypalEmail">
