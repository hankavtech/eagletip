...
<div id="contents">
 ...
 <ul class="nav nav-tabs" id="myTab" role="tablist">
  <li class="nav-item">
    <a class="nav-link active" id="home-tab" href="https://www.eagletip.com/tipsterpersonal/activetips" role="tab" aria-controls="home" aria-selected="true">Today's Tips</a>
  </li>
  <li class="nav-item">
  ...
  <li class="nav-item">
    <a class="nav-link" id="messages-tab" href="https://www.eagletip.com/tipsterpersonal/profile" role="tab" aria-controls="messages" aria-selected="false">Profile</a>
  </li>
</ul>
  ...
  <div class="tab-pane active p-4" id="home" role="tabpanel" aria-labelledby="home-tab">
   ...
   <div class="card bg-dark text-info mb-2 d-table" style="width:240px">
      <div class="card-header">
        ...
        <p class="text-nowrap"><img src="https://www.eagletip.com/images/sport/${item[5]}.svg" style="width:20px;height:20px"/> <img class="ml-2" src="https://www.eagletip.com/images/tipsters/${item[13]}.jpg" onerror="this.onerror=null;this.src='https://www.eagletip.com/images/tipsters/${item[13]}.png'" style="width:30px;height:30px"/></p>
        <p><a class='text-warning' href='https://www.eagletip.com/tipster/activetips?name=${item[13]}'>${item[13]}</a></p>
...
<a class="text-primary" style="text-decoration:underline" href="https://www.eagletip.com/tipster/tips?page=1&name=${sessionScope.tipster_name}">See all tips</a>
</div>
