...
<div id="main-container" class="container mt-5">
  ...
  <li class="nav-item">
    <a class="nav-link active" id="home-tab" href="https://www.eagletip.com/myactivetips" role="tab" aria-controls="home" aria-selected="true">Today's Tips</a>
  </li>
  <li class="nav-item">
...
<div class="tab-content">
  ...
  <c:if test="${empty requestScope.activeuserlist}">
  <h4>You have no active Tips</h4>
  
  </c:if>
    <c:forEach items="${requestScope.activeuserlist}" var="item">
   <div class="col-xs-12 col-sm-6 col-md-4">
   <div class="card bg-dark text-info mb-2 d-table">
      <div class="card-header">
        <p class='text-nowrap'># ${item[12]}</p>
        <p class="text-nowrap"><img src="https://www.eagletip.com/images/sport/${item[5]}.svg" style="width:20px;height:20px"/> <img class="ml-2" src="https://www.eagletip.com/images/tipsters/${item[11]}.jpg" onerror="this.onerror=null;this.src='https://www.eagletip.com/images/tipsters/${item[11]}.png'" style="width:30px;height:30px"/></p>
        <p><a class='text-warning' href='https://www.eagletip.com/tipster/activetips?name=${item[11]}'>${item[11]}</a></p>
      ...
      <div class="card-body">
         ...
         <p>Bookmaker: <span class="bookmakercolumn">${item[10]}</span></p>
         <p></p>
